...
exports.logIn = (req,res) => {
    ...
    //no errors, validation complete then signin
...
exports.uploadImage = (req, res) => {
    ...
    busboy.on('file', (fieldname, file, filename, encoding, mimetype) => {
        ...
        // image file called image.png or my.image.png; take the png only => after splitting, index of last item in array 
        imageExtension = filename.split('.')[filename.split('.').length -1];
        // this image becomes 2345676547564356.png
