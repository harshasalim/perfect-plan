            ...
            <Grid container className= {classes.form}>
                ...
                <Grid item sm>
                    ...
                    <form noValidate onSubmit={this.handleSubmit}>
                        ...
                        error={errors.confirmPassword?true:false} value={this.state.confirmPassword} 
                        onChange={this.handleChange} fullWidth />
                        <TextField id="handle" name="handle" type="text" label="Handle" 
                        className={classes.textField} helperText={errors.handle} 
                        error={errors.handle?true:false} value={this.state.handle} 
                        onChange={this.handleChange} fullWidth />
                        {errors.general && (
                        ...
                        <br />
                        <small style={{color:"#38006b"}}>Already have an account? Login <Link to ="/login"><em>here</em></Link></small>
                    </form>
                </Grid>
                <Grid item sm />
            </Grid>
